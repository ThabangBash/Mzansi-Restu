...
import com.example.thabang.mzansirestus.pojo.ShopMenu;
...
public class ShopRegistrationActivity extends AppCompatActivity {
    ...
    private DatabaseReference databaseReference, uploadRef,uploadRefPDF,profileRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imLogoView = findViewById(R.id.ImageView_shop_logo);
        btnUploadLogo = findViewById(R.id.floatingActionButton_upload_logo);
        btnUploudMenu = findViewById(R.id.button_upload_menu);
        editTradingName = findViewById(R.id.textInput_tranding_name);
        editAbout = findViewById(R.id.textInput_about_business);
        editStreet = findViewById(R.id.textInput_street_address);
        editSuburb = findViewById(R.id.textInput_suburb);
        editCity = findViewById(R.id.textInput_city);
        editCell = findViewById(R.id.textInput_business_cellphone);
        editEmail = findViewById(R.id.textInput_business_email);
        ...
        profileRef = firebaseDatabase.getReference().child("profile").child(uid);
        ...
        if (resultCode == RESULT_OK && requestCode == RESULT_LOAD_IMG) {
            try {
                ...
                uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(ShopRegistrationActivity.this, "Upload Failed -> " + e, Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                e.printStackTrace();
                Toast.makeText(ShopRegistrationActivity.this, "Something went wrong", Toast.LENGTH_LONG).show();
            }
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    pd.dismiss();
                    Toast.makeText(ShopRegistrationActivity.this, "Uploaded successfully", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(ShopRegistrationActivity.this, "You haven't picked a file", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_profile_done) {
            ...
            Intent intent = new Intent(ShopRegistrationActivity.this, LandingActivity.class);
