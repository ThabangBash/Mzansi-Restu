...
public class OwnerProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtUsername = findViewById(R.id.text_input_owner_username);
        txtcellphone = findViewById(R.id.text_view_owner_call);
        txtEmail = findViewById(R.id.text_view_owner_email);
        imgProfilePic = findViewById(R.id.ImageView_owner_pic);
            ...
            try {
                ...
                uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(OwnerProfileActivity.this, "Upload Failed -> " + e, Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                e.printStackTrace();
                Toast.makeText(OwnerProfileActivity.this, "Something went wrong", Toast.LENGTH_LONG).show();
            }

        } else {
            Toast.makeText(OwnerProfileActivity.this, "You haven't picked Image", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_profile_done) {
            ...
            Intent intent = new Intent(OwnerProfileActivity.this,ShopOwnerActivity.class);
